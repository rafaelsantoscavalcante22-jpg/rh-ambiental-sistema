      ...
      <div style={{ padding: "20px 24px 28px" }}>
        ...
        >
          ...
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
            <button onClick={exportarCSV} style={botaoAzulStyle}>
              Exportar financeiro
            </button>

            <button onClick={exportarContasReceberCSV} style={botaoAzulStyle}>
              Exportar contas a receber
            </button>

            <button onClick={carregar} style={botaoAzulStyle}>
                      ...
                      <tr key={item.id} style={{ borderBottom: "1px solid #eef2f7" }}>
                        ...
                        <td style={tdStyle}>
                          ...
                          >
                            ...
                            {isVencido(item) && <span style={badgeVermelho}>Vencido</span>}
                            {isVenceHoje(item) && <span style={badgeRoxo}>Vence hoje</span>}
                            {isAVencer(item) && <span style={badgeLilás}>A vencer</span>}
